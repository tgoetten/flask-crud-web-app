(function(window) {
    ...
    var account = window[window.MailerLiteObject]('accounts')('758636', 'y5e6w4v2p6');
...
(function (window) {
    ...
    cookieName = 'mailerlite:webform:submited:1119026';
    var lastSubmited = getCookie(cookieName);

    if (!lastSubmited) {
    
var cookieName = 'mailerlite:webform:shown:1119026';
...
if (allow_by_device) {
          ...
          var webform = account('webforms', 1119026, 'c3w5m5', 'load');
